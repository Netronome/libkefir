...
#define OPT_FLAGS_USE_MASKS	_BITUL(7)
#define OPT_FLAGS_INLINE_FUNC	_BITUL(8)
#define OPT_FLAGS_NO_LOOPS	_BITUL(9)
#define OPT_FLAGS_CLONE_FILTER	_BITUL(10)
#define OPT_FLAGS_NO_VLAN	_BITUL(11)
#define OPT_FLAGS_USE_PRINTK	_BITUL(12)
